                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_cinema" e method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Cinema Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="cinema_name" placeholder="Cinema Name " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Create Cinema" class="btn btn-primary pull-right">
                                        </div>
