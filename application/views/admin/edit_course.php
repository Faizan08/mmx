                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/update_course/<?php echo $course['courseID'] ?>" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Course Title</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $course['course_title'] ?>" name="course_title" placeholder="Course Title " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Course Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="course_description" placeholder="Course Description " type="text" required="" id="example-text-input" ><?php echo $course['course_description'] ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $course['course_duration'] ?>" name="course_duration"  required="" placeholder="Duration " type="text" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Timings </label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $course['course_timings'] ?>" name="course_timings" required="" placeholder="Example : 11:00 to 1:00  " type="text" id="example-text-input">
                                            </div>
                                        </div>
