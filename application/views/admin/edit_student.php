                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/update_student/<?php echo $student['studentID'] ?>" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Student Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $student['student_name'] ?>" name="student_name" placeholder="Student Name " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Contact Number</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $student['student_contact'] ?>" name="student_contact" placeholder="Contact Number " type="text" required="" id="example-text-input" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $student['student_email'] ?>" name="student_email"  required="" placeholder="Email  " type="email" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="student_address" placeholder="Address " type="text" required="" id="example-text-input" ><?php echo $student['student_address'] ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control select" name="courseID"  type="text" id="example-text-input" required="">
                                        ...
                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Update    Student" class="btn btn-primary pull-right">
                                        </div>
