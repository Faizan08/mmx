                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/update_subcategory/<?php echo  $subcategory['subCategoryID']?>" enctype="multipart/form-data" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Subcategory Title</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $subcategory['subCategoryName'] ?>" name="subCategoryName" placeholder="Subcategory Title " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Subcategory Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" value="" name="subCategoryDesc" placeholder="Subcategory Description " type="text" required="" id="example-text-input" ><?php echo $subcategory['subCategoryDesc'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Category</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" name="categoryID" placeholder="Subcategory Description " required="" id="example-text-input" >
                                                    <option value="">Select Category</option>
                                                    <?php foreach ($categories as $category): ?>
                                                        <option value="<?php echo $category['categoryID'] ?>" <?php if($category['categoryID']==$subcategory['categoryID']) echo "selected" ?>><?php echo $category['categoryName'] ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Subcategory Image</label>
                                            <div class="col-sm-9">
                                                 <?php 
                                                        ...
                                                        ?>
                                                <input class="form-control" name="subCategoryImage" placeholder="Category Description " type="file" id="example-text-input" />
                                            </div>
                                        </div>
                                       
                                        
                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Update Subcategory" class="btn btn-primary pull-right">
                                        </div>
