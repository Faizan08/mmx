                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/update_product/<?php echo $product['productID'] ?>" enctype="multipart/form-data" method="post">
                                            <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Product Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Product Name" name="productName" id="example-text-input" value="<?php echo $product['productName'] ?>">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control subCategoryID" name="subCategoryID" placeholder="Subcategory Description " required="" id="example-text-input" >
                                                    ...
                                                    <?php foreach ($subcategories as $subcategory): ?>
                                                        <option <?php if($product['subCategoryID']==$subcategory['subCategoryID']) echo "selected"  ?> value="<?php echo $subcategory['subCategoryID'] ?>"><?php echo $subcategory['subCategoryName'] ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Product Quantity" name="qty" id="example-text-input" value="<?php echo $product['qty'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" placeholder="Product Description" name="productDesc" id="example-text-input"><?php echo $product['productDesc'] ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" value="<?php echo $product['price'] ?>" placeholder="Price" name="price" id="example-text-input">
                                            </div>
                                        </div>
