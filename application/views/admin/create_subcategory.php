                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_subcategory" enctype="multipart/form-data" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Subcategory Title</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="subCategoryName" placeholder="Subcategory Title " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Subcategory Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="subCategoryDesc" placeholder="Subcategory Description " type="text" required="" id="example-text-input" ></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="subCategoryImage" placeholder="Category Description " type="file" required="" id="example-text-input" />
                                            </div>
                                        </div>
                                       
                                        
                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Create Subcategory" class="btn btn-primary pull-right">
                                        </div>
