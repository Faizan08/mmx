                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/update_news/<?php echo $news['newsID'] ?>" enctype="multipart/form-data" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">News Title</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="title" placeholder="News Title " type="text" required="" value="<?php echo $news['title']?>" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">News Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="description" placeholder="News Description " type="text" required="" id="example-text-input" ><?php echo $news['description']?></textarea>
                                            </div>
                                        </div>
                                       
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">News Image</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="image" placeholder="News Description " type="file" id="example-text-input" />
                                            </div>
                                        </div>
                                       <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Top News</label>
                                           <div class="col-sm-9">
                                                
                                                <select name="is_top" required="" class="form-control">
                                                <option value="">Select </option> 
                                                <option value="1" <?php if($news['is_top']=="1") echo "selected"?>>Yes</option>
                                                <option value="0" <?php if($news['is_top']=="0") echo "selected"?>>No</option>
                                                </select>
                                            </div>
                                        </div>
