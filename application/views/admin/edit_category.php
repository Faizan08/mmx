                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/update_category/<?php echo $category['categoryID'] ?>" enctype="multipart/form-data" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Category Title</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="categoryName" placeholder="Category Title " type="text" required="" value="<?php echo $category['categoryName'] ?>" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Category Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="categoryDesc" placeholder="Category Description " type="text" required="" id="example-text-input" ><?php echo $category['categoryDesc'] ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9"> <br>
                                                 <?php 
                                                        ...
                                                        ?>
                                                        <br>
                                                <input class="form-control" name="categoryImage" placeholder="Category Description " type="file"  id="example-text-input" />
                                            </div>
                                        </div>
