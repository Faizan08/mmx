                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_student" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Student Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="student_name" placeholder="Student Name " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Contact Number</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="student_contact" placeholder="Contact Number " type="text" required="" id="example-text-input" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="student_email"  required="" placeholder="Email  " type="email" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="student_address" placeholder="Address " type="text" required="" id="example-text-input" ></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                               ...
                                               <?php foreach ($courses as $course): ?>
                                                   <option value="<?php echo $course['courseID'] ?>"><?php echo $course['course_title'] ?></option>
                                               <?php endforeach ?>
                                                 </select>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                               ...
                                               <?php foreach ($trainers as $trainer): ?>
                                                   <option value="<?php echo $trainer['trainerID'] ?>"><?php echo $trainer['trainer_name'] ?></option>
                                               <?php endforeach ?>
                                                 </select>
                                            </div>
                                        </div>
