                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_slider" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Create Slider" class="btn btn-primary pull-right">
                                        </div>
