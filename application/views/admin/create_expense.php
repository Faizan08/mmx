                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_expense" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Expense Title</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="expense_title" placeholder="Expense Title " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Expense Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="expense_description" placeholder="Expense Description " type="text" required="" id="example-text-input" ></textarea>
                                            </div>
                                        </div>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="expense_amount" placeholder="Expense Amount " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
