            ...
            <div class="overflow-wrapper">
                ...
                <div class="col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
                    ...
                    <article class="post post--news">
                        ...
                        <h1><a href="#" class="post__title-link">Donec eu mollis augue, ut egestas leo</a></h1>
                    ...
                    <!-- News post article-->
                    <article class="post post--news">
                        <a href='single-page-right.html' class="post__image-link">
                            <img alt='' src="http://placehold.it/1600x600">
                        </a>

                        <h1><a href="single-page-right.html" class="post__title-link">Donec eu mollis augue, ut egestas leo</a></h1>
                        <p class="post__date">29 October 2013 </p>
