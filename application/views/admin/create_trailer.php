                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Create Trailer</li>
                                </ol>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_trailer" enctype="multipart/form-data" method="post">
                                    
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Movie Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="movie_name" placeholder="Movie Name " type="text" required="" id="" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Embed Video</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="embed_video" placeholder="<iframe width='560' height='315' src='https://www.youtube.com/embed/L4IlTltV5UE' frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>" type="text" required="" id="" />
                                            </div>
                                        </div>
                                        
                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Create Trailer" class="btn btn-primary pull-right">
                                        </div>
