                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/update_expense/<?php echo $expense['expenseID'] ?>" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Expense Title</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $expense['expense_title'] ?>" name="expense_title" placeholder="Expense Title " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Expense Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control"  name="expense_description" placeholder="Expense Description " type="text" required="" id="example-text-input" ><?php echo $expense['expense_description'] ?></textarea>
                                            </div>
                                        </div>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $expense['expense_amount'] ?>" name="expense_amount" placeholder="Expense Amount " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
