...
$count=1;
            ...
            <center>    
           <a class="btn btn-md" data-toggle="modal" onclick="get_showing(<?php echo $movie['movie_id'] ?>)" href='#showing' style="background: burlywood;">Show Timing</a> <br><br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title page-heading" style="color: black;">Show Time <?php echo $movies['title'] ?></h4>
            </div>
