                        ...
                        <div class="row">
                                ...
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_product" enctype="multipart/form-data" method="post">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Movie Name" name="title" id="example-text-input">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                         ...
                         <select data-placeholder="Choose Category..." class="select form-control chosen-select" multiple tabindex="3" id="example-text-input" style="background: #555;" name="categoryID[]">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Country" name="country" id="example-text-input">
                                            </div>
                                        </div>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Year" name="year" id="example-text-input">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                 <input class="form-control releasedate" type="text" placeholder="01 Sep 1970" name="release_date" id="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Director" name="director" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Actors" name="actors" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Age Restriction" name="age_restriction" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Box Office" name="box_office" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Length" name="length" id="example-text-input">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="IMD Rating" name="imd_rating" id="example-text-input">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Description" name="description" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="file"  name="mob_cover" id="example-text-input">
                                            </div>
                                        </div>  
