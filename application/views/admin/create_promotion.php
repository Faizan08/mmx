                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="<?php echo base_url() ?>admin/insert_promotion" enctype="multipart/form-data" method="post">
                                    
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Promotion Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="promotion_name" placeholder="Promotion Name " type="text" required="" id="" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Small Tag</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="small_tag" placeholder="Small Tag" type="text" required="" id="" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Promotion Image</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="image" placeholder="Category Description " type="file" required="" id="example-text-input" />
                                            </div>
                                        </div>
                                       
                                        
                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Create Promotion" class="btn btn-primary pull-right">
                                        </div>
