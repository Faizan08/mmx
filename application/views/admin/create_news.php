                                ...
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="title" placeholder="News Title " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">News Description</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="description" placeholder="News Description " type="text" required="" id="example-text-input" ></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="image" placeholder="News Description " type="file" required="" id="example-text-input" />
                                            </div>
                                        </div>
                                       <div class="form-group row">
